...
Write-Host " Local UI: http://localhost:$WebPort  (or http://bboxai:$WebPort, if"
Write-Host " that hostname resolves -- some antivirus/hosts-file protection"
Write-Host " reverts the 'bboxai' hosts entry, so localhost is the reliable one)"
Write-Host ""
